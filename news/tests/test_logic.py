...
class TestCommentCreation(TestCase):
    ...
    def test_user_cant_use_bad_words(self):
        """Формируем данные для отправки формы BAD_WORDS
        """
        # текст включает первое слово из списка стоп-слов.
...
class TestCommentEditDelete(TestCase):
    ...
    def test_author_can_edit_comment(self):
        """
        Проверим, что автор может редактировать свой комментарий.
        """
    ...
    def test_user_cant_edit_comment_of_another_user(self):
        """
        Проверим, что пользователь не может редактировать чужой комментарий.
        """
